...
urlpatterns = [
    ...
    url(r'^transfe_to_basket/', 'index.views.transfe_to_basket', name='transfe_to_basket'),
    url(r'^from_basket_to_stock/', 'index.views.from_basket_to_stock', name='from_basket_to_stock'),
